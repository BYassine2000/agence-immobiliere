...
CREATE DATABASE IF NOT EXISTS agenceimmobiliere;
...
(1, 'yassine', '$argon2id$v=19$m=65536,t=4,p=1$b2RVR3UyLkM3Tkllblg3NQ$2dDOH1JiMv1tNOfrg6K460IJehBjFIWEIMhKIhbE+QY');
COMMIT;
